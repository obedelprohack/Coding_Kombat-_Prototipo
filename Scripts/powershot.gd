...
class_name powershot # Nombre de esta clase
...
func _ready(): #funcion "listo"
	animaciones.play("powershot")
	
	
	
func set_direccion(dir): #funcion para asignar la direccion de movimiento con el paerametro "dir1" 
	velocidad = dir.normalized() * 500 #"velocidad1" es igual a ala direccion direccion normalizada multipliada por 300
